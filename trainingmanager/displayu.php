...
<!-----------------------------------------------------------------------------division-------------------------------------------------------------------------------> 
		     ...
		     <form class="form-detail" method="post">
					...
					<h2>TRAINING REPORT</h2>
                                    ...
                                    <center>
                                        <table border="1">
                                            <thead style="color: #FFF; background-color: gray;"> 
                                                <tr> <th>Id</th>
                                                     <th>Name</th>
                                                     <th>Type</th>
                                                     <th>Description</th>
                                            ...
                                            <tbody>
                                                ...
                                                while($res = mysqli_fetch_array($query))
                                                {
                                                 ...
                                                 <tr class="text-center">
                                                    ...
                                                    <td><button class="btn-primary btn"><a href="update.php?id=<?php echo $res['trainingid']; ?>" class="text-white">Update </a> </button></td>
